...
app.use('/base/2.4.0/78-eb4ac3', express.static('/opt/aruba/central/apps/frontend/build'));
app.use('/base_ui', express.static('/opt/aruba/central/apps/frontend/build'));
app.use('/guest/2.4.0/78-eb4ac3', express.static('/opt/aruba/central/apps/guest_ui/build'));
